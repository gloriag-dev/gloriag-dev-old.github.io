...
export default function Navbar() {
   ...
   return <>
      ...
      <nav className={style.navFlex}>
         ...
         <a className={style.icons} target="_blank" href="https://www.linkedin.com/in/gloriagiannascoli/"><i className="fab fa-linkedin-in"></i></a>
         <a className={style.icons} target="_blank" href="https://github.com/gloriag-dev"><i className="fab fa-github"></i></a> 
      </nav>
   </>
}